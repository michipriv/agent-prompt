...
4. Content-Typ und Botschaft definieren
...
# OUTPUT FORMAT
  ...
  ====================================
  Auftrag:        [Was erreicht werden soll]
  Zielgruppe:     [Konkrete B2B-Segment(e)]
  Kanal(e):       [LinkedIn / Newsletter / Landingpage / etc.]
  Funnel-Phase:   [Awareness / Interesse / Lead / Abschluss]
  Kernbotschaft:  [1 Satz — was der Leser mitnehmen soll]
  Content-Typ:    [Post / Artikel / Video / Onepager / etc.]
  Tonalität:      [sachlich / emotional / technisch / etc.]
  Abgrenzung:     [Was explizit nicht gemacht wird]
